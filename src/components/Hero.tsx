        ...
        <div className="max-w-7xl mx-auto container-padding relative z-10 w-full">
          ...
          >
            ...
            <div className="text-center lg:text-right space-y-6 order-1">
              ...
              >
              <p>نبني مواقع إلكترونيَّة وتطبيقات بكود نظيف قابل للصِّيانة والتَّوسُّع.</p>
              <p>ونُقدِّم للطُّلاب والخرِّيجين الجدد تدريب احترافي متكامل لبناء مواقع إلكترونيَّة وتطبيقات.</p>
