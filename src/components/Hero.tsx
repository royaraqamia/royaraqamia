        ...
        <div className="max-w-7xl mx-auto container-padding relative z-10 w-full">
          ...
          >
            ...
            <div className="text-center lg:text-right space-y-6 order-1">
              ...
              >
               ندرِّبك على بناء موقع إلكتروني أو تطبيق، نقدِّم لك الاستشارة لتحسين مشروعك الرَّقمي، نشبِّكك مع أصحاب المهارات أو أصحاب الأعمال، ننفِّذ مدفوعاتك الإلكترونيَّة، نزوِّدك بنظام لتسعير منتجاتك وخدماتك أو لإدارة الصَّرافة والحوَّالات الماليَّة، نرد على جميع رسائلك، نبني لك موقع إلكتروني أو تطبيق.
              </motion.p>
