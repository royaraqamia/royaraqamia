...
export function SmartPricing() {
  const features = [
    {
      icon: CurrencyDollar,
      title: 'تحديث الأسعار الفوري',
      description: 'عدِّل سعر الصَّرف أو هامش الرِّبح وشاهد كل الأسعار تتحدَّث تلقائيًّا.',
    },
    {
      icon: Calculator,
      title: 'حساب التَّكاليف والأرباح',
      description: 'إجمالي التَّكاليف وصافي الرِّبح يُحسبان تلقائيًّا بدون تدخُّل يدوي.',
    },
    {
      icon: TrendUp,
      title: 'رؤية ماليَّة واضحة',
      description: 'جداول منظَّمة تمنحك نظرة شاملة على أرباحك وتكاليفك.',
    },
    {
      icon: Clock,
      title: 'توفير الوقت والجهد',
      description: 'ودِّع الحسابات اليدويَّة المعقَّدة ومرحبًا بالأتمتة الذَّكيَّة.',
    },
  ];
        ...
        <ScrollAnimation animation="slide-down" duration={0.7}>
          <div className="text-center max-w-3xl mx-auto section-header mb-12">
            ...
            <p className="text-sm sm:text-base lg:text-lg text-foreground/70 leading-[1.8] sm:leading-[1.9]">
              نظام إلكتروني يُتيح لك تحديث أسعار منتجاتك وخدماتك وحساب إجمالي التَّكاليف وصافي
              الرِّبح تلقائيًّا بمجرَّد تعديل سعر الصَّرف أو هامش الرِّبح.
            </p>
          </div>
        </ScrollAnimation>
              ...
              <div className="relative z-10 p-6 md:p-8 rounded-3xl bg-white/5 backdrop-blur-xl">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  {[
                    ...
                    'حسابات تلقائيَّة للأسعار والأرباح',
                    'سهولة التَّعديل والتَّخصيص',
