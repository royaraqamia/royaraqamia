...
export function CreatePostButton() {
  ...
  return (
    <Button
      ...
      className="group relative inline-flex items-center justify-center gap-2 rounded-xl bg-neutral-900 px-4 py-2.5 text-sm font-medium text-neutral-50 shadow-sm transition-safe duration-200 ease-out hover:scale-[1.02] hover:bg-neutral-800 hover:shadow-md hover:shadow-neutral-950/10 active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-neutral-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-60 disabled:shadow-none dark:bg-neutral-50 dark:text-neutral-950 dark:hover:bg-neutral-200 dark:focus-visible:ring-neutral-300 dark:focus-visible:ring-offset-neutral-950 select-none cursor-pointer"
    >
      {pending ? (
