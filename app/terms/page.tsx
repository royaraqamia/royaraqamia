        ...
        <main className="cv-auto space-y-8 text-base leading-relaxed text-muted-foreground sm:space-y-10">
          ...
          >
            ...
            <p className="text-muted-foreground">
              تُقدِّم رؤية رقمية خدمة بناء مواقع وتطبيقات؛ كما تُقدِّم للطُّلاب والخرِّيجين الجدد
              تدريبًا احترافيًّا متكاملًا لبناء المواقع والتَّطبيقات مع شهادة مُوثَّقة من قِبَلنا.
            </p>
          </section>
