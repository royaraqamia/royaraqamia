...
export const metadata: Metadata = {
  ...
  description:
    'شروط الاستخدام لـ رؤيَة رقَميَّة – اقرأ الشُّروط والالتزامات المُتعلِّقة باستخدام خدماتنا.',
  alternates: { canonical: '/terms' },
  openGraph: {
    title: 'شُروط الاستخدام | رؤيَة رقَميَّة',
    description:
      'شروط الاستخدام لـ رؤيَة رقَميَّة – اقرأ الشُّروط والالتزامات المُتعلِّقة باستخدام خدماتنا.',
    url: '/terms',
  ...
  twitter: {
    ...
    title: 'شروط الاستخدام | رؤيَة رقَميَّة',
    description:
      'شروط الاستخدام لـ رؤيَة رقَميَّة – اقرأ الشُّروط والالتزامات المُتعلِّقة باستخدام خدماتنا.',
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        ...
        <main className="cv-auto space-y-8 text-base leading-relaxed text-muted-foreground sm:space-y-10">
          {/* 01. المقدمة */}
          <section
            id="section-1"
          ...
          >
            ...
            <p className="leading-relaxed text-muted-foreground sm:text-lg">
              مرحبًا بك في <strong className="font-bold text-foreground">رؤيَة رقَميَّة</strong>{' '}
              (&quot;نحنُ&quot; أو &quot;المُشغِّل&quot;). باستخدامك لمواقعنا وخدماتنا، فإنَّك توافق
              على الالتزام بهذه الشُّروط. إذا لم توافق على أيٍّ من هذه الشُروط، يُرجَى عدم استخدام
              خدماتنا.
            </p>
          </section>
          ...
          >
            ...
            <p className="text-muted-foreground">
              تُقدِّم رؤيَة رقَميَّة خدمة بناء مواقع وتطبيقات؛ كما تُقدِّم للطُّلاب والخرِّيجين
              الجدد تدريبًا احترافيًّا متكاملًا لبناء المواقع والتَّطبيقات مع شهادة مُوثَّقة من
              قِبَلنا.
            </p>
          </section>
          ...
          >
            <div className="mb-6 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-foreground sm:text-2xl">. الحساب والمُصادقة</h2>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-border/40 bg-muted/40 p-5">
                ...
                <p className="text-muted-foreground">
                  ...
                  الأساسيَّة (الاسم والبريد الإلكتروني وصورة الملف الشَّخصي) وِفقًا لإعدادات
            ...
            <div className="space-y-4">
              <div className="rounded-2xl border border-border/40 bg-muted/40 p-5">
                ...
                <p className="text-muted-foreground">
                  ...
                  برمجيَّة) هي ملكيَّة فكريَّة خاصَّة برؤيَة رقَميَّة أو مُورِّديها. لا يُسمَح بنسخ
                  أو تعديل أو توزيع أو إعادة استخدام أي محتوى دون إذن كتابي مُسبَق.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-border/40 bg-muted/40 p-5">
                ...
                <p className="text-muted-foreground">
                  تحتفظ بملكيَّة المحتوى الذي تُنشئه على منصَّتنا. لكنَّك تمنحنا ترخيصًا غير حصري
                  لاستخدام وعرض هذا المحتوى لتشغيل الخدمات وتقديمها.
                </p>
              </div>
            </div>
          </section>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-foreground sm:text-2xl">. إخلاء المسؤوليَّة</h2>
            </div>
          ...
          >
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-foreground sm:text-2xl">. تعديلات الشُّروط</h2>
            </div>
            <p className="text-muted-foreground">
              نحتفظ بحقِّ تعديل هذه الشُّروط في أيِّ وقت. سنُعلن عن التَّعديلات الجوهريَّة عبر
              الموقع أو عبر البريد الإلكتروني. استمرارك في استخدام الخدمات بعد أيِّ تعديلات يُشكِّل
              قبولًا لها.
            </p>
          </section>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="flex flex-col gap-1.5 rounded-2xl border border-border/50 bg-card/90 p-4 shadow-2xs transition-[color,background-color,border-color,box-shadow,transform,opacity] duration-200 hover:border-primary/50">
                <span className="text-xs font-medium text-muted-foreground">الموقع الإلكتروني</span>
                <a
