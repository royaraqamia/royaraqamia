      ...
      <div className="space-y-8 text-base leading-relaxed text-foreground/90">
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              الأساسيَّة (الاسم والبريد الإلكتروني وصورة الملف الشخصي) وفقًا لإعدادات الخُصوصيَّة في
              حسابك على Google.
            </p>
        ...
        <section>
          ...
          <div className="space-y-3">
            ...
            <p>
              ...
              برمجيَّة) هي ملكيَّة فكريَّة خاصة برؤية رقمية أو مورِّديها. لا يُسمح بنسخ أو تعديل أو
              توزيع أو إعادة استخدام أي محتوى دون إذن كتابي مسبق.
            </p>
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pr-6">
            ...
            <li>
              لا نتحمَّل المسؤوليَّة عن أي أضرار غير مباشرَة أو عرضيَّة أو تبعيَّة ناتجة عن استخدام
              الخدمات.
            </li>
            <li>
