  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        className="size-9 rounded-full bg-muted hover:bg-primary/20 hover:text-primary border border-border hover:border-primary/30 flex items-center justify-center transition-safe"
