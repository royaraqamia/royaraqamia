        ...
        <div className="space-y-8 text-base leading-relaxed text-foreground/90">
          <section>
            ...
            <ul className="list-disc space-y-1 pr-6 mt-3">
              ...
              <li>
                <strong>تطوير مواقع وتطبيقات:</strong> بناء حلول رقميَّة متكاملة من الألف إلى الياء
                للمؤسَّسات وأصحاب الأعمال.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              نوفِّر تسجيل الدُّخول عبر Google كبديل مريح وآمن لإنشاء الحساب والدُّخول إلى المنصَّة.
              يُتيح ذلك للمستخدمين:
            </p>
            <ul className="list-disc space-y-1 pr-6 mt-3">
