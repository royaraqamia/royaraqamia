      ...
      <div className="mx-auto max-w-3xl px-6 py-12 md:py-20">
        ...
        <div className="space-y-8 text-base leading-relaxed text-foreground/90">
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pr-6">
              <li>
                <strong>مُزوِّدو الخدمات:</strong> نستخدم خدمات مُزوِّدين موثوقين مثل Supabase
                (لخزّن البيانات والمُصادقة) و Vercel (لاستضافת الموقع) و Resend (لإرسال رسائل البريد
          ...
          <section>
            ...
            <ul className="list-disc space-y-1 pr-6">
              ...
              <li>
                نحتفظ بمعلوماتك الشخصيَّة فقط للمدة اللازمة لتحقيق الأغراض التي جُمعت من أجلها، أو
                كما يقتضي القانون.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              نستخدم ملفات تعريف ارتباط الضروريَّة لتشغيل الموقع وتأمين الجلسات. لا نستخدم ملفات
              تعريف ارتباط التتبُّع لأغراض تحليليَّة أو تسويقيَّة.
            </p>
          </section>
