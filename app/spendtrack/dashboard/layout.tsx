...
const navItems = [
  { href: '/spendtrack/dashboard', label: 'لوحة التحكم', icon: LayoutDashboard },
  { href: '/spendtrack/dashboard/categories', label: 'التصنيفات', icon: Tags },
];
      ...
      <header role="banner" className="sticky top-0 z-50 border-b border-border/60 glass">
        <div className="flex h-14 items-center justify-between px-4 sm:px-6">
          <div className="flex items-center gap-4 sm:gap-6">
            <Link href="/spendtrack/dashboard" className="shrink-0">
