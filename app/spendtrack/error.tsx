    ...
    <div className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="w-full max-w-md text-center space-y-6" role="alert">
        ...
        <div className="flex items-center justify-center gap-3">
          <button
            onClick={reset}
            className="px-5 py-2.5 bg-primary text-primary-foreground text-sm font-bold rounded-full transition-safe shadow-md flex items-center gap-2 cursor-pointer hover:opacity-90 btn-press btn-lift focus-ring touch-target"
          ...
          <Link
            href="/spendtrack"
            className="px-5 py-2.5 bg-muted hover:bg-muted/80 text-muted-foreground text-sm font-bold rounded-full transition-safe flex items-center gap-2 btn-press focus-ring touch-target"
          >
