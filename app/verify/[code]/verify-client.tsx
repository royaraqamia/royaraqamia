  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden no-print">
        <m.div
          className="absolute -top-32 right-1/4 h-96 w-96 rounded-full bg-red-500/10 blur-[120px]"
          animate={reduce ? false : { scale: [1, 1.15, 1], x: [0, 20, 0] }}
          transition={reduce ? undefined : { duration: 8, repeat: Infinity, ease: 'easeInOut' }}
        />
        <m.div
          className="absolute -bottom-32 left-1/4 h-96 w-96 rounded-full bg-orange-500/10 blur-[120px]"
