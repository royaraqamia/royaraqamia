...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    role: 'متدربة - دورة UI/UX',
    content:
      'مرحبا كيفك أستاذ. صح يمكن خلَّصنا وهيك بس واللّٰه تعبك معنا وتعبنا ما راح عالفاضي، علاماتنا كتير منيحة الحمد للّٰه، والمشروع طلع فخم و أحسنت الاختيار بطريقة توزيعنا. شكرًا 🥹🤍.',
  },
];
