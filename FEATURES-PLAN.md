...
- **Phase 5 — Cross-cutting polish**: palette quick-actions ✅ (`?create=1` deep-link per product) → undo toasts ✅ (HabitFlow/BlogPress/LinkSnap «تراجع») → optimistic UI, onboarding consistency, a11y.
