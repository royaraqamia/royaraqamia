...
export function CertificateQRCodeClient({
  ...
  if (!svg) {
    return (
      <div
        ...
        className={cn(
          'group relative inline-flex max-w-full flex-col items-center justify-center overflow-hidden rounded-3xl border border-white/10 bg-neutral-950/90 p-5 shadow-2xl transition-safe duration-300 ease-out',
          className
        )}
      >
  ...
  return (
    <div
      ...
      className={cn(
        'group relative inline-flex max-w-full flex-col items-center justify-center overflow-hidden rounded-3xl border border-white/10 bg-neutral-950/90 p-5 shadow-2xl shadow-black/80 transition-safe duration-300 ease-out hover:scale-[1.01] hover:border-white/20 hover:shadow-cyan-500/10 active:scale-[0.99] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-500/80 focus-visible:ring-offset-2 focus-visible:ring-offset-neutral-950',
        className
      )}
    >
      ...
      <div className="relative z-10 rounded-2xl border border-white/10 bg-neutral-900/90 p-3 shadow-inner transition-safe duration-300 group-hover:border-white/20 group-hover:bg-neutral-900">
