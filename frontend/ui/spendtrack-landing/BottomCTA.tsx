  ...
  return (
    <SharedBottomCTA
      ...
      decor={
        ...
        >
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 sm:w-187.5 sm:h-187.5 bg-primary/10 rounded-full glow-blur-lg opacity-75" />
