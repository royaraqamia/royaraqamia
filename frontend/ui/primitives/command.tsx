...
function Command({ className, ...props }: React.ComponentProps<typeof CommandPrimitive>) {
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        'bg-popover text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-2xl border border-border/60 shadow-2xl backdrop-blur-2xl transition-transform duration-200 ease-out',
        className
      )}
      {...props}
    />
...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent className="overflow-hidden p-0 rounded-2xl border border-border/80 bg-popover/95 shadow-2xl sm:max-w-xl max-w-[calc(100vw-2rem)] mx-auto">
