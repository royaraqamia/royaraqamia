...
const badgeVariants = cva(
  'inline-flex items-center justify-center shrink-0 max-w-full font-bold select-none rounded-full border text-xs tracking-tight transition-safe duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/80 focus-visible:ring-offset-2 focus-visible:ring-offset-background active:scale-[0.97] disabled:pointer-events-none disabled:opacity-50 gap-1.5',
  {
    variants: {
      variant: {
        default:
        ...
        secondary:
          'border-border/60 bg-secondary/80 text-secondary-foreground hover:bg-secondary hover:border-border hover:text-foreground',
        destructive:
        ...
        outline:
          'border-border/80 bg-background/50 text-foreground hover:bg-accent/80 hover:text-accent-foreground hover:border-border/100 dark:bg-background/20',
        success:
        ...
        glow: 'border-primary/30 bg-primary/10 text-primary shadow-xs shadow-primary/10 hover:bg-primary/20 hover:border-primary/40',
      },
      size: {
