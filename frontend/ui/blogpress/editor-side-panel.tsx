  ...
  return (
    ...
    >
      {open && (
        <DialogContent
          dir="rtl"
          className="sm:max-w-xl w-[calc(100%-1.5rem)] mx-auto p-0 rounded-[28px] border border-border/50 bg-background/95 backdrop-blur-sm shadow-[0_32px_64px_-16px_rgba(0,0,0,0.18)] dark:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.6)]"
        >
