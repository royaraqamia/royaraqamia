  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 right-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-purple-600/14 rounded-full glow-blur-lg transform-gpu" />
        <div className="absolute bottom-0 left-1/4 w-72 sm:w-96 h-72 sm:h-96 bg-indigo-600/14 rounded-full glow-blur-lg transform-gpu" />
        ...
        <ScrollAnimation animation="slide-up" duration={0.8}>
          <div className="relative max-w-4xl mx-auto">
            ...
            <div className="relative rounded-3xl border border-white/10 bg-slate-900/65 px-6 py-12 sm:px-12 sm:py-16 md:py-20 text-center shadow-[0_0_50px_-12px_rgba(147,51,234,0.25)] overflow-hidden group">
              ...
              {/* Status Badge */}
              <div className="inline-flex items-center gap-2.5 px-4 py-1.5 mb-6 sm:mb-8 rounded-full bg-slate-950/88 border border-purple-500/30 text-slate-200 text-xs sm:text-sm font-medium shadow-[0_0_15px_rgba(168,85,247,0.15)] transition-all duration-300 hover:border-purple-500/60 hover:bg-slate-900">
