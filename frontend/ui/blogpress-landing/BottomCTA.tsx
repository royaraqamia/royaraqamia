...
export function BottomCTA() {
  return (
    <SharedBottomCTA
      ...
      card={{
        className:
          'relative rounded-3xl border border-border/60 bg-card/55 p-8 sm:p-12 md:p-16 lg:p-20 shadow-2xl shadow-primary/5 overflow-hidden text-center group/card',
        innerDecor: (
      ...
      primaryButtonClassName="group relative inline-flex items-center justify-center gap-3 h-14 sm:h-16 px-8 sm:px-10 rounded-full bg-primary text-primary-foreground font-bold text-base sm:text-lg shadow-xl shadow-primary/20 hover:shadow-2xl hover:shadow-primary/35 hover:scale-[1.02] active:scale-[0.98] transition-safe duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 border border-primary/30 cursor-pointer"
