...
export function HowItWorks() {
  return (
    <section
      id="how-it-works"
      className="relative py-20 sm:py-28 lg:py-36 overflow-hidden section-spacing"
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 container-padding">
        ...
        <div className="relative">
          {/* Desktop Connected Workflow Timeline Line */}
          <div
            aria-hidden="true"
          ...
          <ol className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-8 relative z-10 list-none m-0 p-0">
            {steps.map((step, i) => {
