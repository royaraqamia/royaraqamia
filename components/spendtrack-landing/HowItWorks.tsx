...
const steps = [
  ...
  },
  {
    ...
    title: 'صوِّر الأنماط',
    description:
      'اعرف أين تذهب أموالك من خلال تحليل التصنيفات والرسوم البيانية والاتجاهات اليومية.',
    icon: ChartPieSlice,
  },
  {
    number: '03',
    title: 'تحكَّم في ميزانيتك',
    description: 'استخدم التحليلات والاتجاهات الشهرية لاتخاذ قرارات مالية أذكى وتوفير المزيد.',
    icon: TrendUp,
  },
];
      ...
      <div className="max-w-6xl mx-auto container-padding">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl font-bold tracking-tight mb-4">
            ثلاث خطوات نحو <span className="gradient-text">الوضوح المالي</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ابدأ بتتبُّع مصروفاتك اليوم وتمتَّع برؤية كاملة لعادات الإنفاق الخاصة بك.
          </p>
        </motion.div>
