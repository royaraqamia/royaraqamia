          ...
          <div className="p-6 overflow-y-auto space-y-4 text-sm">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                نجمع المعلومات التي تقدمها لنا مباشرة عند إنشاء حساب، مثل الاسم والبريد الإلكتروني.
                كما نجمع معلومات تلقائية حول استخدامك للمنصة لتحسين خدماتنا.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                نستخدم المعلومات التي نجمعها لتوفير خدماتنا، وتحسين تجربة المستخدم، وإرسال إشعارات
                مهمة، واتخاذ تدابير أمنية، والامتثال للالتزامات القانونية.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                لا نشارك معلوماتك الشخصية مع أطراف ثالثة إلا بموافقتك أو كما هو مطلوب قانوناً. قد
                نشارك المعلومات مع مقدمي الخدمات الذين يساعدوننا في تشغيل المنصة.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                نحن نأخذ أمان بياناتك بجدية. نستخدم تقنيات تشفير حديثة لحماية معلوماتك ونقوم بمراجعة
                ممارسات الأمان لدينا بانتظام.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                نستخدم ملفات تعريف الارتباط لتحسين تجربتك على المنصة. يمكنك إدارة تفضيلات ملفات
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                لديك الحق في الوصول إلى معلوماتك الشخصية وتصحيحها أو حذفها. يمكنك أيضاً سحب موافقتك
                على معالجة بياناتك في أي وقت.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر. سنقوم بإبلاغك بأي تغييرات مهمة من
                خلال المنصة أو البريد الإلكتروني.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                إذا كان لديك أي أسئلة حول سياسة الخصوصية هذه، يرجى الاتصال بنا عبر البريد
