      ...
      <div className="relative z-10 max-w-4xl mx-auto container-padding py-32 text-center">
        ...
        >
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight leading-[1.1] mb-6">
            هل أنت مستعد <span className="gradient-text">لتتبُّع كل نقرة؟</span>
          </h2>

          <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
            انضم إلى آلاف مديري الروابط الأذكياء. اختصِر، تتبَّع، وحسِّن روابطك باستخدام منصة
            التحليلات القوية من LinkSnap.
          </p>
