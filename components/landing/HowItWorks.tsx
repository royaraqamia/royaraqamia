...
export function HowItWorks() {
  return (
    ...
    >
      {/* Ambient background blur glow for visual depth */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="relative">
          {/* Linear Desktop Step Connector Line */}
          <div
          ...
          <ol className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-8 relative z-10">
            {steps.map((step, i) => {
